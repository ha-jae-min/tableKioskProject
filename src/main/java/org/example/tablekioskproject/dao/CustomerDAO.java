...
//    public List<DetailVO> getAllOrderDetails() throws Exception {
//        log.info("getAllOrderDetails called");
//        List<DetailVO> detailsList = new ArrayList<>();
//
//        String sql = """
//            SELECT d.ono, d.mno, d.quantity, d.total_price,
//                   m.category_id, m.name AS menu_name, m.description AS menu_description,
//                   m.price AS menu_price, m.is_sold_out, m.is_recommend
//            FROM tbl_k_menu m
//            INNER JOIN tbl_k_detail d ON m.mno = d.mno
//            """;
//
...
//                    .price(rs.getBigDecimal("menu_price"))
//                    .is_sold_out(rs.getBoolean("is_sold_out"))
//                    .isRecommend(rs.getBoolean("is_recommend"))
//                    .build();
//
...
//    }
    ...
    // Insert order detail into tbl_k_detail
